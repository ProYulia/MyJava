...
//        BinaryNode.bypassNode(root);
        ...
        tNode1.addChild(tNode5);

        TreeNode.treeSearch(tNode0);
        TreeNode.preOrder(tNode0);
        TreeNode.postOrder(tNode0);

//        System.out.println("Total nodes: " + TreeNode.nodesCounter);
//        System.out.println(tNode4.nodeID + "");
//        System.out.println(tNode5.equals(tNode2));
